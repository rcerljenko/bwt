...
gcc -std=gnu11 -Wall -Wextra -s -march=native -Ofast -flto -shared -fPIC -o libbwt.so libbwt.c

App:

gcc -std=gnu11 -Wall -Wextra -s -march=native -Ofast -flto -Wl,-rpath=. -L. -o bwt bwt.c -pthread -lbwt
