...
- On Windows with MinGW set compiler flags to match commands below.
- Or use CMake on any platform.

Shared lib:
gcc -std=gnu11 -Wall -Wextra -s -march=native -Ofast -flto -fPIC -shared -Wl,-soname,libbwt.so -o libbwt.so libbwt.c

App:
gcc -std=gnu11 -Wall -Wextra -s -march=native -Ofast -flto -Wl,-rpath=. -L. -o pbwt pbwt.c -pthread -lbwt
